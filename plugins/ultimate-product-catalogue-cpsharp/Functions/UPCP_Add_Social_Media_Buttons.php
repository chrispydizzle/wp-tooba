...
function UPCP_Add_Social_Media_Buttons($Social_Media, $Permalink, $Title) {
    ...
    switch ($Social_Media) {
        ...
        case 'Facebook':
            ...
            $ReturnString .= "<a href='https://www.facebook.com/sharer/sharer.php?u=" . $Permalink . "' class='popup' target='_blank'>";
            $ReturnString .= "<span class='rrssb-icon'>";
        ...
        case 'Linkedin':
            ...
            $ReturnString .= "<a href='http://www.linkedin.com/shareArticle?mini=true&amp;url=" . $Permalink . "&amp;title=" . $URL_Encoded_Text . "&amp;summary=" . $URL_Encoded_Title . "' class='popup' target='_blank'>";
            $ReturnString .= "<span class='rrssb-icon'>";
            $ReturnString .= "<svg xmlns='http://www.w3.org/2000/svg' width='28' height='28' viewBox='0 0 28 28'>";
        ...
        case 'Twitter':
            ...
            $ReturnString .= "class='popup' target='_blank'>";
            $ReturnString .= "<span class='rrssb-icon'>";
            $ReturnString .= "<svg xmlns='http://www.w3.org/2000/svg' width='28' height='28' viewBox='0 0 28 28'>";
        ...
        case 'Google':
            ...
            $ReturnString .= "<a href='https://plus.google.com/share?url=" . $URL_Encoded_Text . $URL_Encoded_Text_Concat . $URL_Encoded_Title . $URL_Encoded_Permalink_Concat . $URL_Encoded_Permalink . "' class='popup' target='_blank'>";
            $ReturnString .= "<span class='rrssb-icon'>";
            $ReturnString .= "<svg xmlns='http://www.w3.org/2000/svg' width='28' height='28' viewBox='0 0 28 28'>";
        ...
        case 'Pinterest':
            ...
            $ReturnString .= "<a href='http://pinterest.com/pin/create/button/?url=" . $Permalink . "&amp;description=" . $URL_Encoded_Text . $URL_Encoded_Text_Concat . $URL_Encoded_Title . "' target='_blank'>";
            $ReturnString .= "<span class='rrssb-icon'>";
            $ReturnString .= "<svg xmlns='http://www.w3.org/2000/svg' width='28' height='28' viewBox='0 0 28 28'>";
